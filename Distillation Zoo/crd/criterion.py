...
"""
Code extracted from: https://github.com/HobbitLong/RepDistiller
"""
...
class CRDLoss(nn.Module):
    ...
    """
    def __init__(self, CONFIG, s_dim, t_dim, n_data):
        super(CRDLoss, self).__init__()

        feat_dim = CONFIG['DISTILLATION']['FEAT_DIM']
        nce_k = CONFIG['DISTILLATION']['K']
        nce_t = CONFIG['DISTILLATION']['T']
        nce_m = CONFIG['DISTILLATION']['M']
