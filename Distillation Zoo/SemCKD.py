...
"""
Code extracted from: https://github.com/DefangChen/SemCKD
"""


class SemCKDLoss(nn.Module):
    """Cross-Layer Distillation with Semantic Calibration, AAAI2021"""
    def __init__(self, feat_s, feat_t, bs, s_n, t_n):
        super(SemCKDLoss, self).__init__()

        self.crit = nn.MSELoss(reduction='none')

        self.self_attention = SelfA(len(feat_s) - 2, len(feat_t) - 2, bs, s_n, t_n)
