...
class ResNet(nn.Module):
    ...
    def __init__(self, depth, num_filters, block_name='BasicBlock', num_classes=10, multiscale=False):
    ...
    def forward(self, x):
        ...
        a0 = self.layer1(x)  # 32x32
        a1 = self.layer2(a0)  # 16x16
        a2 = self.layer3(a1)  # 8x8

        x = self.avgpool(a2)
        a3 = x.view(x.size(0), -1)
        x = self.fc(a3)
